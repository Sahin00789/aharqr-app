    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-xs sm:text-sm">Real-time active table occupancy, active orders, and floor activity.</p>
        </div>
        <button
      ...
      {/* ACTIVE TABLES FLOOR MATRIX */}
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-extrabold text-white flex items-center gap-2">
            <Utensils className="w-5 h-5 text-emerald-400" /> Active Floor Tables & Live Orders Matrix
          </h3>
          <span className="text-xs text-slate-400 font-medium">Click any table to view order history & activity</span>
        </div>
