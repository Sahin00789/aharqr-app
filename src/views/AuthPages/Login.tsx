...
export default function Login() {
  ...
  const roles = [
    { 
      ...
      icon: ShieldCheck, 
      activeCard: 'bg-linear-to-br from-blue-500/20 via-blue-600/10 to-indigo-500/10 border-blue-500 shadow-[0_0_25px_-5px_rgba(59,130,246,0.4)] text-blue-400',
    ...
    { 
      ...
      desc: 'Floor & Orders',
      icon: UserCheck, 
      activeCard: 'bg-linear-to-br from-emerald-500/20 via-emerald-600/10 to-teal-500/10 border-emerald-500 shadow-[0_0_25px_-5px_rgba(16,185,129,0.4)] text-emerald-400',
    ...
    { 
      ...
      desc: 'Kitchen KDS',
      icon: ChefHat, 
      activeCard: 'bg-linear-to-br from-amber-500/20 via-amber-600/10 to-orange-500/10 border-amber-500 shadow-[0_0_25px_-5px_rgba(245,158,11,0.4)] text-amber-400',
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/25">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950/80 border border-slate-800/90 rounded-2xl pl-10 pr-10 py-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all"
                />
                <button
                  type="button"
