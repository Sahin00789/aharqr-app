...
export default function CaptainDashboardLayout() {
  ...
  const navItems = [
    ...
    { id: 'alerts', label: 'Alerts & Menu', icon: Bell, to: '/captain/alerts', badge: 2 },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex selection:bg-emerald-500/30">
      ...
      <div className="flex-1 flex flex-col lg:pl-20 min-w-0">
        ...
        <DashboardTopbar 
          ...
          iconBgClass="from-emerald-500 to-teal-600 shadow-emerald-500/20"
          onProfileClick={() => setIsMenuListOpen(true)}
          extraRightElement={
            <div className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-mono font-extrabold text-xs">
