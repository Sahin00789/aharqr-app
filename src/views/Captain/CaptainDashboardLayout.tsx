...
export default function CaptainDashboardLayout() {
  ...
  const navItems = [
    ...
    { id: 'profile', label: 'Shift Roster', icon: UserCheck, to: '/captain/account/menu' },
  ];
          ...
          <div className="flex items-center gap-3 px-1 pt-1 justify-center xl:justify-start">
            ...
            {!user || !isInitialized ? (
              ...
              <div className="hidden xl:block min-w-0">
                ...
                <span className="inline-block px-1.5 py-0.5 rounded text-[9px] font-extrabold uppercase bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                  CAPTAIN SIDENAV
                </span>
              </div>
            )}
                ...
                >
                  ...
                  {item.badge !== undefined && (
                    <span className={`absolute top-2 right-2 xl:static px-1.5 py-0.5 rounded-full text-[9px] font-extrabold ${
                      isActive ? 'bg-white/20 text-white' : 'bg-emerald-500 text-slate-950'
                    }`}>
                      {item.badge}
                    </span>
                  )}
        ...
        {!user || !isInitialized ? (
          ...
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 font-extrabold text-white text-xs flex items-center justify-center border border-emerald-400/40 shrink-0">
              ...
              <div className="hidden xl:block min-w-0">
                ...
                <p className="text-[10px] text-slate-400 truncate leading-tight">Floor Hub</p>
              </div>
            </div>
